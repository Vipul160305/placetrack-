...
import { Users, CheckCircle, TrendingUp, DollarSign, Building2, BarChart3 } from 'lucide-react';
...
export default function TPOAnalytics() {
    ...
    return (
        <div>
            <PageHeader title="Analytics Dashboard" subtitle="Comprehensive placement statistics and insights" />
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-6">
                ...
                <StatCard title="Placement %" value={`${stats.placementPercentage}%`} icon={TrendingUp} color="violet" />
                <StatCard title="Avg Package" value={`${stats.averagePackage} LPA`} icon={DollarSign} color="amber" />
                <StatCard title="Highest Pkg" value={`${stats.highestPackage} LPA`} icon={TrendingUp} color="rose" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div className="lg:col-span-2 bg-slate-900 border border-slate-800 rounded-xl p-5">
                    <h3 className="text-slate-300 font-semibold mb-4 flex items-center gap-2"><BarChart3 size={16} /> Branch-wise Placement</h3>
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
                    <h3 className="text-slate-300 font-semibold mb-4">Placement Overview</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
                    <h3 className="text-slate-300 font-semibold mb-4">Applications by Status</h3>
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
                    <h3 className="text-slate-300 font-semibold mb-4">Branch Performance</h3>
                            ...
                            return (
                                <div key={row._id}>
                                    <div className="flex justify-between text-sm mb-1">
                                        ...
                                        <span className="text-slate-400">{row.placed}/{row.total} • <span className={`font-bold ${pct >= 50 ? 'text-emerald-400' : 'text-amber-400'}`}>{pct}%</span></span>
                                    </div>
